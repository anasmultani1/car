...
class CarController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['search'] = $search; $data['cars'] = []; $data['apiCars'] = [];
    ...
    private function fetchCarModels($make){
        ...
        try {
            ...
            $data = json_decode($response,true); $cars = [];
            ...
            foreach($data['Results'] as $model){
                ...
                $cars[] = [
                    'model_name'=>$name,'make_display'=>$brand,'model_year'=>'N/A','poster'=>$image,
                    'engine'=>'N/A','fuel'=>'N/A','transmission'=>'N/A','drive'=>'N/A','doors'=>'N/A','seats'=>'N/A'
                ];
            }
            return $cars;
    ...
    public function saveReview(){
        ...
        $reviewModel = new ReviewModel();
        $existing = $reviewModel->where('user_id',$userId)->where('car_id',$carId)->first();
